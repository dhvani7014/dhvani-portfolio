...
export const techStack = {
  ...
  "Frontend & Full-Stack": ["React.js", "React Native", "Next.js", "TypeScript", "HTML/CSS", "Streamlit"],
  "Databases & Cloud": ["PostgreSQL", "MongoDB", "MySQL", "Neo4j", "Snowflake", "AWS (EC2, S3, Lambda)"],
  "Developer Tools": ["Git", "GitHub Actions", "CI/CD", "Docker", "Kubernetes", "Postman"],
  "AI/ML & Data": ["PyTorch", "TensorFlow", "RAG", "LangGraph", "Prompt Engineering", "Hugging Face", "NumPy", "Pandas"],
};
